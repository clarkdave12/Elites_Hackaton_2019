            ...
            <div class="osahan-account-page-right shadow-sm bg-white p-4 h-100">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane  fade  active show" id="orders" role="tabpanel" aria-labelledby="orders-tab">
                        <h4 class="font-weight-bold mt-0 mb-4">Community</h4>
                            ...
                            <div class="gold-members p-4">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <a href="#">
                                            <span class="float-right text-info">Posted on Mon, Nov 12, 7:18 PM <i class="icofont-check-circled text-success"></i></span>
                                        </a>
                                        <h6 class="mb-2">
                                            <a href="#"></a>
                                            <a href="#" class="text-black">Allan Adan</a>
                                        </h6>
                                        <p class="text-gray mb-1"><i class="icofont-location-arrow"></i> Write something here, Write something here
                                        , Write something here, Write something here, Write something here, Write something here, Write something here
                                        </p>
                                        
                                        <hr>
                                        <div class="float-right">
                                            <a class="btn btn-sm btn-outline-primary" href="#"><i class="icofont-headphone-alt"></i> Like</a>
                                            <a class="btn btn-sm btn-primary" href="#"><i class="icofont-refresh"></i> Comment</a>
                                        </div>
                                        <p class="mb-0 text-black text-primary pt-2"><span class="text-black font-weight-bold"> Likes:</span> 1000
                                        </p>
                                        <p class="mb-0 text-black text-primary pt-2"><span class="text-black font-weight-bold"> Comment:</span> 1000
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="gold-members p-4">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="mb-2">
                                            <a href="#"></a>
                                            <a href="#" class="text-black">Rowella Amor</a>
                                        </h6>
                                        <p class="text-gray mb-1"><i class="icofont-location-arrow"></i> Write something here, Write something here
                                        , Write something here, Write something here, Write something here, Write something here, Write something here
                                        </p>
                            ...
                            <div class="gold-members p-4">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h6 class="mb-2">
                                            <a href="#"></a>
                                            <a href="#" class="text-black">Marlon Ocsan</a>
                                        </h6>
                                        <p class="text-gray mb-1"><i class="icofont-location-arrow"></i> Write something here, Write something here
                                        , Write something here, Write something here, Write something here, Write something here, Write something here
                                        </p>
